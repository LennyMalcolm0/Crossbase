...
const ChangeableProfileItem = ({profileItem, profileItemValue, countryCode}: Props) => {
    return (  
        <div className="text-[#D9D9D9] mb-[10px] opacity-80 ">
            <label className="text-[12px] ">{profileItem}</label>
            <div className="w-full p-[15px] rounded-[10px] bg-[#1F1F1E] border border-[#D9D9D9] text-[14px] flex items-center justify-between ">
                {!countryCode ?
