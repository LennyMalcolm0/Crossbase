    ...
    return (  
        <div className="h-full w-full flex flex-col justify-between "> 
            <div>
                ...
                <label className="text-[12px] text-[#D9D9D9] ">Amount Staked</label>
                <div className="relative">
                    ...
                    <div className="absolute top-0 left-[20px] text-[14px] leading-[48px] font-semibold uppercase  ">NGN</div>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-0 left-[20px] text-[14px] leading-[48px] font-semibold uppercase  ">NGN</div>
                    <div className="absolute top-0 left-[150px] text-[14px] text-[#CCFF01] leading-[48px] font-semibold uppercase  ">(+7,520)</div>
                </div>
            ...
            <div className="">
                ...
                <div className="h-[52px] w-full grid grid-cols-2 gap-x-2 text-center leading-[52px] font-bold ">
                    <Link to="/new-stake" className="w-full h-full rounded-[10px] bg-[#CCFF01] text-[#121313] text-[17px] ">Increase Stake</Link>
                    <Link to="withdraw-stake" className="w-full h-full rounded-[10px] border border-[#CCFF01] text-[#CCFF01] ">Withdraw Stake</Link>
                </div>
            </div>
        </div>
    );
