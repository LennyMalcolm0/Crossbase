        ...
        <div className="h-screen w-full max-h-[1000px] max-w-[400px] absolute top-0 left-0 bg-[#121313] px-[20px] py-[35px] ">
            <div className="h-full w-full ">   
                ...
                <div className="flex justify-center my-[40px] ">
                    <img src="Currencies\NGN-GHS.svg" alt="" className="h-[45px]" />
                </div>

                <div className="text-center text-white text-[14px] mb-[40px] ">
                    <div>NGN to GHS</div>
                ...
                <div className="h-[52px] w-full grid grid-cols-2 gap-x-2 text-center leading-[52px] font-bold mt-[100px] ">
